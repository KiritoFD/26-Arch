...
set_property include_dirs [list [file join $repo_root vsrc] [file join $repo_root vivado src] [file join $ip_root clk_wiz_0]] [get_filesets sources_1]
set_property include_dirs [list [file join $repo_root vsrc] [file join $repo_root vivado src] [file join $ip_root clk_wiz_0]] [get_filesets sim_1]

# ================================================================
# Test: Program SPI Flash with bitstream-only MCS file
# Use spix1 interface (matches our SPI controller)
# ================================================================
...
# Step 1: Create MCS file from bitstream
...
# List available flash parts
puts "Available flash parts:"
set parts [get_cfgmem_parts {n25q*}]
foreach p $parts {
    puts "  $p"
}

# Program SPI Flash with bitstream-only MCS

# program_flash_v2.tcl - Program SPI Flash (load bridge first, then flash)
# Vivado 2019.2 batch mode needs FPGA programmed first to access SPI Flash
...
puts "=========================================="
puts "Programming SPI Flash (with FPGA bridge)"
puts "=========================================="
...
# Step 3: Re-program FPGA (to reload fresh bitstream after flash programming)
puts "Step 3: Re-programming FPGA..."
set_property PROGRAM.FILE $bitstream_path $device
program_hw_devices $device
